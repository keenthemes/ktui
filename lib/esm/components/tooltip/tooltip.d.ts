...
export declare class KTTooltip extends KTComponent implements KTTooltipInterface {
    ...
    protected _popper: Instance | null;
    ...
    static getInstance(element: HTMLElement): KTTooltip | null;
    static getOrCreateInstance(element: HTMLElement, config?: KTTooltipConfigInterface | null): KTTooltip;
