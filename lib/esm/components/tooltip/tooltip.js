...
var KTTooltip = /** @class */ (function (_super) {
    ...
    KTTooltip.prototype._getTargetElement = function () {
        ...
        return (KTDom.getElement(query) || this._element.querySelector(query));
    };
    ...
    KTTooltip.prototype._handleContainer = function () {
        ...
        if (container) {
            if (container === 'body') {
                ...
                var containerElement = KTDom.getElement(container);
    ...
    KTTooltip.prototype._setZindex = function () {
        ...
        var elementZindex = KTDom.getCssProp(this._element, 'z-index');
        if (elementZindex && parseInt(elementZindex) > zindex) {
            zindex = parseInt(elementZindex);
        }
        var highestZindex = KTDom.getHighestZindex(this._element);
