...
var KTSelect = /** @class */ (function (_super) {
    ...
    KTSelect.prototype._setupComponent = function () {
        ...
        this._dropdownModule = new KTSelectDropdown(this._wrapperElement, this._displayElement, this._dropdownContentElement, this._config, this // Pass the KTSelect instance to KTSelectDropdown
        );
