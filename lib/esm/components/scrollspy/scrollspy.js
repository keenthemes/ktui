...
var KTScrollspy = /** @class */ (function (_super) {
    ...
    function KTScrollspy(element, config) {
        ...
        if (!_this._element)
            return _this;
        var targetElement = _this._getTarget() === 'body' ? document : KTDom.getElement(_this._getTarget());
        if (!targetElement)
            return _this;
    ...
    KTScrollspy.prototype._handlers = function () {
        ...
        KTEventHandler.on(this._element, '[data-scrollspy-anchor]', 'click', function (event, target) {
    ...
    KTScrollspy.prototype._updateAnchor = function (anchorElement) {
        ...
        if ((scrollPosition + offset) >= offsetTop) {
            ...
            var parentAnchorElements = KTDom.parents(anchorElement, '[data-scrollspy-group]');
